...
TRANSLATIONS = {
    'fr': {
        ...
        'max_signature_length': 'Longueur maximale de la signature (pb)',
        'target_signature_length': 'Longueur cible de la signature (pb)',
        'target_signature_length_desc': 'Détermine la géométrie idéale',
    ...
    'en': {
        ...
        'max_signature_length': 'Max signature length (bp)',
        'target_signature_length': 'Target signature length (bp)',
        'target_signature_length_desc': 'Determines ideal geometry',
...
def execute_lava_background(execution_id, script_type, input_file, output_name, params):
    ...
    try:
        ...
        param_mapping = {
            ...
            'total_signature_length': 'total_signature_length',

...
TRANSLATIONS = {
    'fr': {
        ...
        'min_signature_length': 'Longueur min signature',
    ...
    'en': {
        ...
        'min_signature_length': 'Min signature length',
...
def execute_lava_background(execution_id, script_type, input_file, output_name, params):
    ...
    try:
        ...
        param_mapping = {
            ...
            'signature_min_length': 'signature_min_length',
        ...
        common_params = {
            'signature_max_length', 'signature_min_length', 'max_primer_gen', 'primer_min_match_percent',
